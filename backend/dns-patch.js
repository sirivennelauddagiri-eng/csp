...
// Only apply DNS resolution patches and replica set rewrites in non-production local environments.
// Render has its own healthy internal DNS resolver and dynamic IP configuration.
if (process.env.NODE_ENV !== 'production' && process.env.RENDER !== 'true') {
    ...
    if (process.env.MONGO_URI && process.env.MONGO_URI.includes('cleanliness.g3r9imw.mongodb.net')) {
        ...
        if (credsMatch) {
            ...
            const directUri = `mongodb://${user}:${pass}@ac-qiv7m4p-shard-00-02.g3r9imw.mongodb.net:27017,ac-qiv7m4p-shard-00-00.g3r9imw.mongodb.net:27017,ac-qiv7m4p-shard-00-01.g3r9imw.mongodb.net:27017/?ssl=true&replicaSet=atlas-pxtz4c-shard-0&authSource=admin&appName=cleanliness`;
    ...
    console.log("✈️ Production/Render environment detected. Bypassing DNS resolution patch.");
}
